...
in words])
    ...
    def decode(self, array):
        ...
        code = code.rstrip('0')
        result = ' '.join([''.join([next(k for k, v in 
Morse.alpha.items() if v == char)
                                    for char in 
words.split('000')]) for words in code.split('0' * 7)])
...
if __name__ == '__main__':
    ...
    print(Morse.decode([-1440552402, -1547992901, -1896993141, 
-1461059584]))
